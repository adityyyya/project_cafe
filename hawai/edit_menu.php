        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="section-content bg-white p-5 shadow">
					...
					$q = $koneksi->query("SELECT * FROM menu WHERE id_menu = $id_menu");
					...
					?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="hidden" class="form-control" name="id_menu" placeholder="menu" value="<?= $data['id_menu'];?>">
                            </div>
							...
							<div class="col-md-12 form-group">
                                <select class="form-control" name="id_jenis">
									...
									while($pilihan_jenis = $q->fetch_assoc()){ ?>
										<option value="<?= $pilihan_jenis['id_jenis']; ?>"
										<?php
											if($pilihan_jenis['id_jenis'] == $data['id_jenis']){
												echo "selected";
											}
										?>>
											<?= $pilihan_jenis['nama_jenis']; ?>
											</option>	
									<?php } ?>
								</select>
                            </div>
