...
<!-- Testimonial Section-->
<section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image: url(img/food1.jpg);">
    <div class="container">
    ...
    while($data = $q->fetch_assoc()){
        echo"<tr bgcolor=darkslategray >
            ...
            <td>
			  ...
			  <a class='btn btn-success btn-sm' href='cetak_riwayat.php?id_pembelian=$data[id_pembelian]'>
