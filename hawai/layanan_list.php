            ...
            <div class="col-lg-5">
                <div class="section-content bg-white p-5 shadow">
                    <div class="heading-section text-center">
                        ...
                        <h2>
                            Saran & Komentar Tentang Resto Hawai
			
                        </h2>
                    </div>
                    <form method="post"  action="proses_komentar_saran.php">
                        <div class="row">
							...
							<div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control" id="komentar" name="komentar" rows="6" placeholder="Your Message ..."></textarea>
                            </div>
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-shadow btn-lg" type="submit" name="submit">Kirim</button>
                            </div>
                        </div>
                    </form>
                </div>
