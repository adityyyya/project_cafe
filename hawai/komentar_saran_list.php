...
<!-- Testimonial Section-->
<section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image: url(img/pantai1.jpg);">
    <div class="container">
...
<?php
    ...
    $q = $koneksi->query("SELECT * FROM saran_komentar_layanan");
...
<br>
	...
	<div class="card-tools" align="center">
                <a class="btn btn-primary" href="layanan_list.php"><i class="fas fa-plus mr-1"></i>Tambah Komentar</a>
                </div>		
