            ...
            <div class="col-lg-5">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
								...
								while($pilihan_pelanggan = $q->fetch_assoc()){
									echo "<option value='$pilihan_pelanggan[id_pelanggan]'>
										$pilihan_pelanggan[nama_pelanggan]</option>";		
								}
								  ?>
								 </select>
                            </div>
							...
							<select class="form-control" name="no_meja">
								...
								while($pilihan_meja = $q->fetch_assoc()){
									echo "<option value='$pilihan_meja[no_meja]'>
										$pilihan_meja[kapasitas]</option>";		
								}
								  ?>
								 </select>
                            </div>
               ...
               <br>
                            <div class="col-md-12 text-center">
                                <button align="center" class="btn btn-primary btn-shadow btn-lg" type="submit" name="submit">Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
