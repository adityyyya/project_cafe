    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav d-flex justify-content-between">
                ...
                <a class="btn btn-primary" href="tambah_menu_form.php"><i class="fas fa-plus mr-1"></i>Tambah Data</a>
                </div>
            </ul>
        </div>
    </div>
...
<!-- Testimonial Section-->
<section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image: url(img/rempah6.jpg);">
    <div class="container">
...
<?php
    ...
    while($data = $q->fetch_assoc()){
        echo"<tr bgcolor=darkslategray>
            ...
            <td>
              <a class='btn btn-warning btn-sm' href='edit_menu.php?id_menu=$data[id_menu]'>
              <i class='fas fa-edit mr-1'></i>Edit</a>
            
              <a class='btn btn-danger btn-sm' href='proses_hapus_menu.php?id_menu=$data[id_menu]'>
...
<br>
		<div class="heading-section text-center">
			...
			<div class="heading-section text-center">
				...
				<a class="btn btn-primary" href="list_item_pembelian.php">
