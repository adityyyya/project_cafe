...
<?php
	...
	$nim = $_GET['id_pembelian'];
	
    $q = $koneksi->query("SELECT pembelian.id_pembelian, pelanggan.nama_pelanggan, pembelian.no_meja, pembelian.tgl_beli, menu.nama_menu
                    FROM pembelian, pelanggan , menu
                    WHERE pembelian.id_pelanggan = pelanggan.id_pelanggan
					AND pembelian.id_menu = menu.id_menu
					AND pembelian.id_pembelian = $nim;
	");
