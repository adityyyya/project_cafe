    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav d-flex justify-content-between">
                ...
                <a class="btn btn-primary" href="tambah_item_pembelian_form.php"><i class="fas fa-plus mr-1"></i>Tambah Data</a>
                </div>
            </ul>
        </div>
    </div>
...
<?php
    ...
    $q = $koneksi->query("SELECT pembelian.id_pembelian, menu.nama_menu, item_pembelian.jumlah
                            FROM pembelian,menu,item_pembelian
                            WHERE pembelian.id_pembelian = item_pembelian.id_pembelian
                            AND menu.id_menu = item_pembelian.id_menu");
    ...
    while($data = $q->fetch_assoc()){
        echo"<tr bgcolor=darkslategray>
            ...
            <td>
              <a class='btn btn-warning btn-sm' href='edit_item_pembelian.php?id_pembelian=$data[id_pembelian]'>
              <i class='fas fa-edit mr-1'></i>Edit</a>
            
              <a class='btn btn-danger btn-sm' href='proses_hapus_list_item_pembelian.php?id_pembelian=$data[id_pembelian]'>
