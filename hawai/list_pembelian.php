    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav d-flex justify-content-between">
                ...
                <a class="btn btn-primary" href="tambah_pembelian_form.php"><i class="fas fa-plus mr-1"></i>Tambah Data</a>
                </div>
            </ul>
        </div>
    </div>
...
<br> 
<!-- Testimonial Section-->
<section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image: url(img/rempah2.jpg);">
    <div class="container">
...
<?php
    ...
    while($data = $q->fetch_assoc()){
        echo"<tr bgcolor=darkslategray >
            ...
            <td>
              <a class='btn btn-warning btn-sm' href='edit_pembelian_form.php?id_pembelian=$data[id_pembelian]'>
...
<br>
			...
			<div class="heading-section text-center">
				<a class="btn btn-primary" href="list_pelanggan.php">
				<i class="fas fa-angle-double-left mr-1"></i>
				</a>
                <a class="btn btn-primary" href="jenismenu_list.php">
