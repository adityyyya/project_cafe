        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="section-content bg-white p-5 shadow">
					...
					$q = $koneksi->query("SELECT * FROM pelanggan WHERE id_pelanggan = $id_pelanggan");
					...
					?>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <input type="hidden" class="form-control" name="id_pelanggan" placeholder="id pelanggan" value="<?= $data['id_pelanggan'];?>">
                            </div>
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" name="nama_pelanggan" placeholder="nama pelanggan" value="<?= $data['nama_pelanggan'];?>">
                            </div>
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" name="no_hp" placeholder="no hp" value="<?= $data['no_hp'];?>">
                            </div>
							<div class="col-md-12 form-group">
