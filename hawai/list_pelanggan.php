    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav d-flex justify-content-between">
                ...
                <a class="btn btn-primary" href="tambah_pelanggan_form.php"><i class="fas fa-plus mr-1"></i>Tambah Data</a>
                </div>
            </ul>
        </div>
    </div>
...
<!-- Testimonial Section-->
<section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image: url(img/rempah1.jpg);">
    <div class="container">
...
<?php
    ...
    while($data = $q->fetch_assoc()){
        echo"<tr bgcolor=darkslategray>
            ...
            <td>$data[alamat]</td>
            <td>
              <a class='btn btn-warning btn-sm' href='edit_pelanggan_form.php?id_pelanggan=$data[id_pelanggan]'>
