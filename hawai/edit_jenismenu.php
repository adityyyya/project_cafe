        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="section-content bg-white p-5 shadow">
                    ...
                    <form method="post"  action="proses_edit_jenismenu.php">
					<?php
					//mengambil data dari method get
					$id_jenis = $_GET['id_jenis'];
					
					$q = $koneksi->query("SELECT * FROM jenis_menu WHERE id_jenis = $id_jenis");
					...
					?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="hidden" class="form-control" name="id_jenis" placeholder="jenis" value="<?= $data['id_jenis'];?>">
                            </div>
							
							<div class="col-md-12 form-group">
                                <input type="text" class="form-control" name="nama_jenis" placeholder="jenis menu" value="<?= $data['nama_jenis'];?>">
                            </div>
